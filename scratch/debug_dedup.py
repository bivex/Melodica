...
export_multitrack_midi(tracks_data, "scratch/test_dd.mid", humanize=True)

import mido
mid = mido.MidiFile("scratch/test_dd.mid")
active = {}
anomalies = []
abs_time = 0
for msg in mid.tracks[1]:
    ...
    if msg.type == 'note_on' and msg.velocity > 0:
        if msg.note in active:
            anomalies.append(f"Anomaly: Note {msg.note} started at {abs_time}, previous at {active[msg.note]}")
