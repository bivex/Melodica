...
TRANSITION_FUNK: dict[float, dict[float, float]] = {
    0.25: {0.25: 0.45, 0.5: 0.35, 0.75: 0.1, 1.0: 0.1},
    0.5: {0.5: 0.3, 0.25: 0.35, 0.75: 0.15, 1.0: 0.15, 1.5: 0.05},
    0.75: {0.5: 0.35, 0.25: 0.3, 1.0: 0.2, 0.75: 0.15},
    1.0: {0.25: 0.3, 0.5: 0.3, 1.0: 0.2, 0.75: 0.15, 1.5: 0.05},
    1.5: {0.5: 0.35, 0.25: 0.3, 1.0: 0.25, 0.75: 0.1},
    2.0: {0.5: 0.3, 0.25: 0.3, 1.0: 0.25, 0.75: 0.15},
    4.0: {0.5: 0.35, 0.25: 0.3, 1.0: 0.2, 2.0: 0.15},
}

TRANSITION_LATIN: dict[float, dict[float, float]] = {
    0.25: {0.25: 0.35, 0.5: 0.3, 0.75: 0.2, 1.0: 0.15},
    0.5: {0.5: 0.25, 0.75: 0.25, 1.0: 0.2, 0.25: 0.15, 1.5: 0.15},
    0.75: {0.5: 0.3, 0.75: 0.2, 1.0: 0.25, 1.5: 0.15, 0.25: 0.1},
    1.0: {1.0: 0.2, 0.75: 0.2, 1.5: 0.2, 0.5: 0.2, 0.25: 0.1, 2.0: 0.1},
    1.5: {0.5: 0.3, 1.0: 0.25, 0.75: 0.2, 1.5: 0.15, 2.0: 0.1},
    2.0: {1.0: 0.3, 0.75: 0.2, 0.5: 0.2, 1.5: 0.2, 2.0: 0.1},
    4.0: {1.0: 0.3, 0.75: 0.25, 1.5: 0.2, 0.5: 0.15, 2.0: 0.1},
}

TRANSITION_WALTZ: dict[float, dict[float, float]] = {
    0.25: {0.25: 0.3, 0.5: 0.35, 0.75: 0.2, 1.0: 0.15},
    0.5: {0.5: 0.3, 1.0: 0.3, 0.75: 0.2, 1.5: 0.15, 0.25: 0.05},
    0.75: {0.75: 0.2, 0.5: 0.3, 1.0: 0.25, 1.5: 0.2, 0.25: 0.05},
    1.0: {1.0: 0.25, 1.5: 0.25, 2.0: 0.2, 0.5: 0.2, 0.75: 0.1},
    1.5: {1.5: 0.2, 1.0: 0.3, 0.75: 0.2, 2.0: 0.2, 0.5: 0.1},
    2.0: {2.0: 0.25, 1.0: 0.25, 1.5: 0.25, 0.5: 0.15, 4.0: 0.1},
    4.0: {1.0: 0.35, 1.5: 0.25, 2.0: 0.2, 0.5: 0.15, 0.75: 0.05},
}

TRANSITION_HIP_HOP: dict[float, dict[float, float]] = {
    0.25: {0.25: 0.4, 0.5: 0.35, 0.75: 0.15, 1.0: 0.1},
    0.5: {0.5: 0.3, 0.25: 0.25, 0.75: 0.2, 1.0: 0.2, 1.5: 0.05},
    0.75: {0.5: 0.3, 0.25: 0.25, 1.0: 0.25, 0.75: 0.15, 1.5: 0.05},
    1.0: {1.0: 0.25, 0.5: 0.3, 0.25: 0.2, 0.75: 0.15, 2.0: 0.1},
    1.5: {0.5: 0.3, 1.0: 0.3, 0.75: 0.2, 2.0: 0.15, 0.25: 0.05},
    2.0: {1.0: 0.3, 0.5: 0.25, 0.75: 0.2, 2.0: 0.15, 1.5: 0.1},
    4.0: {1.0: 0.35, 0.5: 0.3, 2.0: 0.2, 0.75: 0.1, 1.5: 0.05},
}

TRANSITION_DNB: dict[float, dict[float, float]] = {
    0.25: {0.25: 0.55, 0.5: 0.3, 0.75: 0.1, 1.0: 0.05},
    0.5: {0.5: 0.4, 0.25: 0.35, 0.75: 0.15, 1.0: 0.1},
    0.75: {0.5: 0.4, 0.25: 0.3, 1.0: 0.15, 0.75: 0.15},
    1.0: {0.25: 0.35, 0.5: 0.35, 1.0: 0.15, 0.75: 0.1, 1.5: 0.05},
    1.5: {0.5: 0.4, 0.25: 0.3, 1.0: 0.2, 0.75: 0.1},
    2.0: {0.5: 0.35, 0.25: 0.35, 1.0: 0.2, 0.75: 0.1},
    4.0: {0.5: 0.4, 0.25: 0.35, 1.0: 0.15, 0.75: 0.1},
}

TRANSITION_AFRO: dict[float, dict[float, float]] = {
    0.25: {0.25: 0.35, 0.5: 0.3, 0.75: 0.2, 1.0: 0.15},
    0.5: {0.5: 0.25, 0.75: 0.25, 1.0: 0.2, 0.25: 0.15, 1.5: 0.15},
    0.75: {0.75: 0.2, 0.5: 0.3, 1.0: 0.2, 1.5: 0.2, 0.25: 0.1},
    1.0: {0.75: 0.25, 0.5: 0.25, 1.0: 0.2, 1.5: 0.2, 0.25: 0.1},
    1.5: {1.0: 0.25, 0.75: 0.25, 0.5: 0.2, 1.5: 0.15, 2.0: 0.15},
    2.0: {1.5: 0.3, 1.0: 0.3, 0.75: 0.2, 0.5: 0.1, 2.0: 0.1},
    4.0: {1.5: 0.3, 1.0: 0.3, 2.0: 0.2, 0.75: 0.1, 0.5: 0.1},
}
...
STYLE_MATRICES: dict[str, dict[float, dict[float, float]]] = {
    ...
    "funk": TRANSITION_FUNK,
    "latin": TRANSITION_LATIN,
    "waltz": TRANSITION_WALTZ,
    "hip_hop": TRANSITION_HIP_HOP,
    "dnb": TRANSITION_DNB,
    "afro": TRANSITION_AFRO,
}
...
class MarkovRhythmGenerator(RhythmGenerator):
    ...
    style:
        "straight", "swing", "ballad", "driving", "funk", "latin",
        "waltz", "hip_hop", "dnb", "afro", or "custom"
    transitions:
