...
# New submodules
from melodica.generators._melody_rhythm import RhythmBuilder
...
class MelodyGenerator(PhraseGenerator):
    ...
    def render(
        ...
        for i, event in enumerate(events):
            ...
            vel = velocity_proc.apply(base_vel, event, phrase_pos, progress)
        ...
        # Store motif for next call
        if motif_notes and len(motif_notes) >= 3:
            motif_mgr.store_motif(motif_notes)
